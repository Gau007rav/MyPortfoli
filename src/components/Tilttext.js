...
function Tilttext() {
  ...
  return (
    ...
    >
      {/* Title Text */}
      <h1 className="text-white font-[anzo2] text-4xl md:text-6xl lg:text-5xl uppercase">
        I am Dark Mode
      </h1>

      {/* Subtitle Text */}
      <h1 className="text-gray-300 uppercase font-[anzo3] text-5xl md:text-8xl lg:text-7xl">
        Developer
      </h1>

      {/* Call to Action */}
      <h1 className="text-white uppercase font-[anzo1] text-4xl md:text-6xl lg:text-7xl">
        To Hire
      </h1>
    </div>
  );
