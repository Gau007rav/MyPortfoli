  ...
  return (
    <div className="bg-gradient-to-b from-gray-900 via-black to-gray-800 p-5 flex flex-col md:flex-row">
      ...
      <div className="bg-black rounded-lg w-full md:w-1/2 flex flex-col justify-center items-start p-10 mb-5 md:mb-0">
        <h1 className="text-white text-[160px] sm:text-[150px] md:text-[180px] lg:text-[200px] uppercase font-[anzo4] leading-[150px] sm:leading-[150px] md:leading-[200px]">
          What
        </h1>
        <h1 className="text-white text-[160px] sm:text-[150px] md:text-[180px] lg:text-[200px] uppercase font-[anzo4] leading-[150px] sm:leading-[150px] md:leading-[200px] mt-5 sm:mt-10 md:mt-10">
          I Do
        </h1>
      </div>
